...
static Point_3 find_median_point_contender_impl(Vertex_iterator begin, Vertex_iterator end, std::size_t size) {
    Smaller smaller;
...
static Point_3 find_median_point_contender(Vertex_list& V, int coord) {
    ...
    switch(coord) {
        case 0: return find_median_point_contender_impl<Smaller_x_3>(V.begin(), V.end(), V.size());
        case 1: return find_median_point_contender_impl<Smaller_y_3>(V.begin(), V.end(), V.size());
        case 2: return find_median_point_contender_impl<Smaller_z_3>(V.begin(), V.end(), V.size());
        default:
